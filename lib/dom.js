 ...
 * @property {LineWrap} [wrap] How to wrap lines.
 */
 ...
 * @param {symbol|util.Style} styleType What color to use?
 ...
 *
 * @param {string} str String to colorize.
 * @param {symbol|util.Style} type Color.
 * @param {MaybeStylized} options Look at color option.
 * @returns {string} Colorized string.
 * @private
 */
